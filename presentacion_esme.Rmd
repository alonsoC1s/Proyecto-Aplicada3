...
- Pregunta clave: ¿Está bien distribuido el sistema de transporte público para servir a las necesidades de la población de la ciudad?
...
- Verificamos que se cumpla homocedasticidad, no autocorrelación y rango completo

## Pruebas de White, Breusch-Godfrey y VIF (valor inflacionario de la varianza)

- Para las pruebas de White y Breusch-Godfrey ka hipótesis nula es homocedasticidad y no autocorrelación, respectivamente
- Los valores-p son ceros numéricos entonces no se rechaza la hipótesis nula y, se cumplen homocedasticidad y no autocorrelación
- El valor VIF más grande es 1, entonces al estar debajo de 30, no tenemos problemas de multicolinealidad
...
## Análisis aplicado por alcaldía
...
- Para Milpa Alta ningún coeficiente es significativo al 10%, entonces podría ser de poco interés para contruir transporte
